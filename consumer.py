    ...
    def create_listener(self, function):
        def listener(function):
            while True:
                ...
                print('stargin on new job!', str(msg_dict['id']), msg_dict)
                # process msg ...
            ...
            while True:
                ...
                for i in range(0, (queued_jobs_length // 5) + 1, 5):
                    ...
                    for job_key in job_keys:
                        ...
                        if time_now - job['timestamp'] > job_timeout:
                            pipeline = self.redis.pipeline()
                            pipeline.lrem(self.processing_q, -1, job_str)
                            ...
                            # leave it in the jobs refs queue
